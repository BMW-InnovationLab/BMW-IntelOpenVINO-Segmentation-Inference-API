...
from application.inference.services.loading_model_service import LoadingModel
from application.inference.services.image_visualizer_service import ImageVisualizer
...
class Inference:
    ...
    def image_inference(self, model_name: str, input_data):
        ...
        image, visualizer, tracker, presenter = self.image_visualizer.visualizer(input_data,model_name)
